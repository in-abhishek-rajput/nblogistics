    ...
    <form wire:submit.prevent="save">
        <div class="row">
            ...
            <div class="col-md-12 mb-3">
                <input type="text" wire:model="truck_number" class="form-control @error('truck_number') is-invalid @enderror"
                    ...
                    @foreach ($ownerships as $key => $ownership)
                        <div class="form-check">
                            <input class="form-check-input" type="radio" wire:model="ownership" value="{{ $key }}"
                                id="ownership_{{ $key }}" {{ $ownership == 'Self' ? 'checked' : '' }}>
        ...
        <div class="d-flex justify-content-end gap-2">
            ...
            <button type="submit" class="btn btn-primary" wire:loading.attr="disabled" wire:target="save">
                <span wire:loading.remove wire:target="save">Add Truck</span>
