<div wire:ignore.self class="modal fade" id="addFuelExpenseModal" tabindex="-1" aria-labelledby="addFuelExpenseModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            <div class="modal-header border-bottom-0">
                <h5 class="modal-title fw-bold" id="addFuelExpenseModalLabel">Add Fuel Expense</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form wire:submit.prevent="createFuelExpense">
                <div class="modal-body py-0 px-4">
                    ...
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" wire:model.live="is_full_tank" id="isFullTank">
                        <label class="form-check-label" for="isFullTank">I Have Filled Full Tank</label>
                    </div>
                    <div class="mb-3">
                    ...
                    @if ($payment_mode === 'cash' || $payment_mode === 'credit' || $payment_mode === 'paid_by_driver' || $payment_mode === 'online')
                        <div class="mb-3">
                ...
                <div class="modal-footer border-top-0 pt-0 pb-4 px-4">
                    ...
                    <button type="submit" class="btn btn-primary">Save Fuel Expense</button>
                </div>
            </form>
        </div>
    </div>
