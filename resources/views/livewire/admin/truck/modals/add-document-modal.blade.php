            ...
            <form wire:submit.prevent="saveDocument">
                <div class="modal-body py-0 px-4">
                    <div class="mb-3">
                        ...
                        <input type="text" wire:model.defer="document_name" class="form-control" required
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" wire:model.defer="document_number" class="form-control">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" wire:model="document_file" class="form-control" accept="image/jpeg,image/png,image/jpg,application/pdf">
                        @if ($document_file)
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" wire:model.defer="expense_amount" class="form-control" min="0" step="0.01">
