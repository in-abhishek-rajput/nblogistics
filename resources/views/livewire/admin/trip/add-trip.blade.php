                ...
                <div class="row">
                    ...
                    @else
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><i class="fas fa-rupee-sign"></i></span>
                                <input type="number" step="0.01" value="{{ $per_unit_amount }}" wire:model="per_unit_amount" class="form-control @error('per_unit_amount') is-invalid @enderror"
                                    placeholder="0.00">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" step="0.01" wire:model="unit" value="{{ $unit }}" class="form-control @error('unit') is-invalid @enderror"
                                placeholder="0.00">
                            @error('unit')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><i class="fas fa-rupee-sign"></i></span>
                                <input type="number" step="0.01" wire:model="freight_amount" value="{{ $freight_amount }}"  class="form-control" readonly
