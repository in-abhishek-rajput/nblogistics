    ...
    <form wire:submit.prevent="save">
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="date" value="{{ $opening_balance_date }}" wire:model="opening_balance_date" class="form-control @error('opening_balance_date') is-invalid @enderror"
        ...
        <div class="d-flex justify-content-end gap-2">
            ...
            <button type="submit" class="btn btn-primary" wire:loading.attr="disabled" wire:target="save">
                <span wire:loading.remove wire:target="save">Update Party</span>
