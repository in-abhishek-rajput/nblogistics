...
@section('content')
    ...
    <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-2">
        <a href="#" class="navbar-brand d-flex me-4">
            <h1 class="mb-0 fs-5">Parties</h1>
        </a>
    </nav>

    <!-- Parties Management Start -->
    <div class="container-fluid pt-4 px-4">
        <div class="bg-light rounded-top p-4 shadow-sm">
            <div class="row">
                <div class="col-md-6 col-6 mb-3">
                    <div class="border p-3 rounded d-flex align-items-center gap-3">
                        <label class="mob-font">TOTAL PARTY BALANCE <i class="bi bi-info-circle"></i></label>
                        <h3 class="text-primary mb-0 d-flex">
                ...
                <div class="col-md-6 col-6 mb-3">
                    <div class="border p-3 rounded d-flex align-items-center gap-3">
                        <label class="mob-font">TOTAL ACTIVE TRIPS <i class="bi bi-info-circle"></i></label>
                        <h3 class="text-success mb-0">0</h3>
                    </div>
                </div>
            </div>

            <!-- Dynamic Parties List -->
            <livewire:admin.party.list-parties />
        </div>

    </div>
    <!-- Parties Management End -->
